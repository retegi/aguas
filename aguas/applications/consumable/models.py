...
class TypeConsumable(models.Model):
    ...
    imagen_typeConsumable = models.ForeignKey(ImageConsumable, on_delete=models.CASCADE,null=False, blank=False)
    observations_typeConsumable = models.CharField('Observaciones', max_length=50)
    ...
    def __str__(self):
        return str(self.type_typeConsumable) + '' +  str(self.brand_typeConsumable) + '' + str(self.model_typeConsumable) + '' + str(self.voltage_ouput_typeConsumable)
...
class Consumable(models.Model):
    ...
    STATUS_CONSUMABLE_CHOICE = (
        ('0','Almacén'),
        ('1','Operativo'),
        ('2','Baja'),
        ('3','Otro'),
    )
    status_consumable = models.CharField('Estado consumible', max_length=1, choices=STATUS_CONSUMABLE_CHOICE,null=True)
    ...
    def __str__(self):
        return str(self.serial_num_consumable) + '' + str(self.type_consumable)